const RestaurentSection = () => {
  return (
    ...
    >
      <div className="text-5xl font-bold text-center">Restaurent Section</div>
      <div className="mt-10">
        ...
        odit sed quia modi quam voluptates. Sequi, repellendus, temporibus culpa
        ad commodi saepe ipsa quos harum odit quasi possimus qui distinctio
        tenetur adipisci a, expedita aspernatur odio sit. Nisi, maxime!
        Inventore impedit officia ipsa quod dolorem voluptatibus maiores,
        reiciendis quidem minus unde provident debitis quisquam perspiciatis
        omnis voluptatem voluptas nesciunt repudiandae in laboriosam deserunt.
        Quam possimus nihil nisi quas repellendus, quae tempore dolore quibusdam
        in sunt, aperiam doloremque consequuntur. Perspiciatis nihil, fugiat ut
        ea harum saepe ab voluptatem. Lorem ipsum dolor sit amet consectetur
        ...
        porro. Debitis provident accusamus vitae dicta libero odio aut nulla
        sapiente ipsa repudiandae atque quas, quam possimus dolores voluptatum
        voluptatibus illum iusto deserunt fuga autem. Suscipit aperiam provident
        quod tempore recusandae repellat quasi sit nobis unde ut quis
        voluptatibus laborum a, ab qui minima maiores ex officiis animi eius?
        Alias ut, fugiat soluta recusandae tenetur sapiente reprehenderit
        voluptatum similique corporis qui quis ratione minima quas! Temporibus
        asperiores adipisci numquam ipsam optio autem sequi voluptatibus id
        reiciendis porro nesciunt recusandae maiores ipsum illum quas rerum
        obcaecati doloribus impedit, odit sed quia modi quam voluptates. Sequi,
        repellendus, temporibus culpa ad commodi saepe ipsa quos harum odit
        quasi possimus qui distinctio tenetur adipisci a, expedita aspernatur
        odio sit. Nisi, maxime! Inventore impedit officia ipsa quod dolorem
        voluptatibus maiores, reiciendis quidem minus unde provident debitis
        quisquam perspiciatis omnis voluptatem voluptas nesciunt repudiandae in
        laboriosam deserunt. Quam possimus nihil nisi quas repellendus, quae
        tempore dolore quibusdam in sunt, aperiam doloremque consequuntur.
        Perspiciatis nihil, fugiat ut ea harum saepe ab voluptatem.
      </div>
    </div>
  );
};
