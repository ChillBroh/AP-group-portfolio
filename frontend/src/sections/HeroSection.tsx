    ...
    >
      ...
      <div className="flex flex-col md:flex-row p-6 md:p-20">
        ...
        <div className="flex flex-col gap-4 mr-0 md:mr-20 mb-8 md:mb-0">
          ...
          <div className="flex items-center gap-2 animate-fade-right animate-once animate-ease-linear animate-duration-400 animate-delay-500">
            <div className="p-4 bg-white rounded-full shadow-md">
              <FaGlobe className="text-primary-base" size={24} />
            </div>
            <span>PA Group Consulting</span>
          </div>
          <div className="flex items-center gap-2 animate-fade-right animate-once animate-ease-linear animate-duration-400 animate-delay-[1000ms]">
            <div className="p-4 bg-white rounded-full shadow-md">
              <FaWifi className="text-primary-base" size={24} />
            </div>
            <span>SIM / WIFI Connection Campaign</span>
          </div>
          <div className="flex items-center gap-2 animate-fade-right animate-once animate-ease-linear animate-duration-400 animate-delay-[1500ms]">
            <div className="p-4 bg-white rounded-full shadow-md">
              <FaMobileAlt className="text-primary-base" size={24} />
            </div>
            <span>Mobile Credit and Connection Campaign</span>
          </div>
          <div className="flex items-center gap-2 animate-fade-right animate-once animate-ease-linear animate-duration-400 animate-delay-[2000ms]">
            <div className="p-4 bg-white rounded-full shadow-md">
              <FaLanguage className="text-primary-base" size={24} />
            </div>
            <span>Language Translation</span>
          </div>
          <div className="flex items-center gap-2 animate-fade-right animate-once animate-ease-linear animate-duration-400 animate-delay-[2500ms]">
            <div className="p-4 bg-white rounded-full shadow-md">
